...
# e.g. checkpoints/classification/efficientnet_b0_balanced_lr2.5e-5
CONFIG['save_dir'] = str(CLASSIFICATION_CKPT_DIR / f"efficientnet_b0_balanced_lr{lr_tag(CONFIG['lr'])}")
